- mfnetsim depends on ROSS and CODES software packages.
...
CC=mpicc CXX=mpicxx CCLD=mpicxx CFLAGS=-g -O0 --prefix=/path/to/mfnetsim/install
...
--workload-conf-file=$HOME_CODES/mfnetsim/checkpoint-study/workload-files/workload-512.conf
--rank-alloc-file=cont-alloc-9702-2048.conf
--codes-config=$HOME_CODES/mfnetsim/checkpoint-study/config-files/test-checkpoint-dfly-1T.conf
